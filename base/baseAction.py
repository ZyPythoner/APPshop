...
class Baseaction:
    ...
    # 自定义了一个可以自动帮我们拼接 xpath 路径的工具函数 ---例子："text,登录/注册,1"
    ...
    # # 定义一函数，来获取登录按钮的 enabled 状态
    # def get_enabled(self, feature):
    #     ele = self.find_element(feature)
    #     return ele.get_attribute("enabled")
    #
    # # 定义一个函数 来判断当前的按钮状态是可以点击，还是不可以点击
    # def is_enabled(self, feature):
    #     # 如果能点击，我们返回True 否则返回False
    #     if self.get_enabled(feature) == "false":
    #         return False
    #     else:
    #         return True
